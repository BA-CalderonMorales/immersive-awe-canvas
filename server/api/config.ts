...
// Add GitHub routes
githubAPI.addRoute('releases', '/repos/BA-CalderonMorales/immersive-awe-canvas/releases');
githubAPI.addRoute('latestRelease', '/repos/BA-CalderonMorales/immersive-awe-canvas/releases/latest');
...
internalAPI.setConfig('baseUrl', process.env.INTERNAL_API_URL || 'http://localhost:3001');
