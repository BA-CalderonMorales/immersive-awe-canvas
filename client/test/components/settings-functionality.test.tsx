...
describe("Settings Panel Functionality Tests", () => {
    ...
    describe("Material Settings Changes", () => {
        it("should update material metalness when slider is changed", async () => {
            ...
            const metalnessSlider = screen.getByTestId(
        ...
        it("should update material roughness when slider is changed", async () => {
            ...
            const roughnessSlider = screen.getByTestId(
        ...
        it("should update material type when dropdown is changed", async () => {
            ...
            const materialTypeSelect = screen.getByTestId(
    ...
    describe("Light Controls", () => {
        it("should update ambient light intensity when slider is changed", async () => {
            ...
            const ambientIntensitySlider = screen.getByTestId(
                "ambient-light-intensity-slider"
            );
            fireEvent.change(ambientIntensitySlider, {
                target: { value: "2.0" },
            });
        ...
        it("should update directional light intensity when slider is changed", async () => {
            ...
            const directionalIntensitySlider = screen.getByTestId(
                "directional-light-intensity-slider"
            );
            fireEvent.change(directionalIntensitySlider, {
                target: { value: "1.5" },
            });
    ...
    describe("Background Controls", () => {
        it("should update background type when selection is changed", async () => {
            ...
            const backgroundSelect = screen.getByTestId(
    ...
    describe("Motion Control", () => {
        it("should call onToggleMotion when play/pause button is clicked", async () => {
            ...
            const motionToggleButton = screen.getByTestId(
...
const MockSettingsPanel = ({
    ...
    return (
        <div data-testid="settings-panel">
            {/* Reset Button */}
            <button data-testid="reset-scene-button" onClick={handleReset}>
                Reset Scene
            </button>
            ...
            <select
                ...
                onChange={e =>
                    handleMaterialChange("materialType", e.target.value)
                }
            >
            ...
            {/* Motion Controls */}
            <button data-testid="motion-toggle-button" onClick={onToggleMotion}>
                {isMotionFrozen ? (
