...
const AtmosphericParticles = ({ theme, count = 200 }: AtmosphericParticlesProps) => {
  ...
  useFrame((state) => {
    ...
    particles.forEach((particle, i) => {
      ...
      const breathingScale = particle.scale * (1 + Math.sin(timeRef.current * 0.5 + particle.phase) * 0.3);
