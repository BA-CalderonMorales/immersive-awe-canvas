...
const DynamicMaterial = ({ materialConfig, color }: DynamicMaterialProps) => {
    ...
    const matcapKey =
        (materialConfig.matcapTexture as keyof typeof MATCAP_TEXTURES) ||
        "chrome";
    const [matcap] = useMatcapTexture(
        MATCAP_TEXTURES[matcapKey] || MATCAP_TEXTURES.chrome,
        256
    );
    ...
    const commonProps = {
        ...
        opacity:
            materialConfig.opacity !== undefined ? materialConfig.opacity : 1,
    };
        ...
        case "physical":
            return (
                <meshPhysicalMaterial
                    {...commonProps}
                    roughness={
                        materialConfig.roughness !== undefined
                            ? materialConfig.roughness
                            : 0.5
                    }
                    metalness={
                        materialConfig.metalness !== undefined
        ...
        case "toon":
            return (
                <meshToonMaterial
                    {...commonProps}
                    gradientMap={
                        materialConfig.gradientMap === "five"
                            ? fiveTone
                            : threeTone
                    }
                />
        ...
        case "phong":
            return (
                <meshPhongMaterial
                    {...commonProps}
                    shininess={
                        materialConfig.shininess !== undefined
                            ? materialConfig.shininess
                            : 30
                    }
        ...
        case "normal":
            return (
                <meshNormalMaterial
                    ...
                    transparent={materialConfig.transparent || false}
                    opacity={
                        materialConfig.opacity !== undefined
