...
const InstancedFieldElements = ({
    color,
    materialConfig,
    fieldData,
    isLocked,
}: InstancedFieldElementsProps) => {
    ...
    useFrame(state => {
        ...
        const mouseInfluence =
            Math.sqrt(mouse.x * mouse.x + mouse.y * mouse.y) * 0.4;
        ...
        fieldInstanceRefs.current.forEach((instancedMesh, meshIndex) => {
            ...
            fieldData.positions.forEach((position, fieldIndex) => {
                if (
                    ...
                    const wobble = getWobbleDistortion(
                        position,
                        timeRef.current,
                        fieldIndex
                    );
                    ...
                    switch (meaning) {
                        case "memory":
                            ...
                            meaningMotion.y =
                                Math.sin(timeRef.current * 0.3 + fieldIndex) *
                                0.3;
                            break;
                        case "question":
                            ...
                            meaningMotion.y =
                                Math.abs(
                                    Math.sin(timeRef.current * 0.8 + fieldIndex)
                                ) * 0.4;
                            meaningMotion.scaleMultiplier =
                                1 +
                                Math.sin(timeRef.current * 1.5 + fieldIndex) *
                                    0.2;
                            break;
                        case "insight":
                            ...
                            meaningMotion.scaleMultiplier =
                                1 +
                                Math.sin(timeRef.current * 2 + fieldIndex) *
                                    0.3;
                            break;
                        case "doubt":
                            ...
                            meaningMotion.x =
                                Math.sin(
                                    timeRef.current * 1.1 + fieldIndex * 2
                                ) * 0.2;
                            meaningMotion.z =
                                Math.cos(
                                    timeRef.current * 0.9 + fieldIndex * 3
                                ) * 0.2;
                            break;
                        case "wonder": {
                            // Wonder creates spiral motion in the field
                            const spiralTime =
                                timeRef.current * 0.5 + fieldIndex;
                        ...
                        case "truth":
                            ...
                            meaningMotion.scaleMultiplier =
                                1 + Math.sin(timeRef.current * 0.4) * 0.1;
                            break;
                        case "mystery":
                            ...
                            meaningMotion.scaleMultiplier =
                                0.5 +
                                Math.abs(
                                    Math.sin(timeRef.current * 0.7 + fieldIndex)
                                ) *
                                    0.8;
                            break;
                    }
                    ...
                    const energyColor = new Color().setHSL(
                        fieldEnergy / 360,
                        0.4 +
                            Math.sin(timeRef.current * 0.5 + fieldIndex) * 0.2,
                        0.5 +
                            Math.cos(timeRef.current * 0.3 + fieldIndex) * 0.15
                    );
            ...
            {[...Array(6)].map((_, i) => {
                ...
                return (
                    <mesh
                        ...
                        scale={[
                            0.08,
                            3 + Math.sin(timeRef.current * 0.8 + i) * 1,
                            0.08,
                        ]}
                    >
