        ...
        <>
            ...
            {[...Array(3)].map((_, i) => (
                <mesh
                    ...
                    position={[
                        Math.cos((i * Math.PI) / 1.5 + timeRef.current * 0.02) *
                            5, // Very slow orbital motion
                        Math.sin(timeRef.current * 0.08 + i * 2) * 0.8, // Gentle floating
                        Math.sin((i * Math.PI) / 1.5 + timeRef.current * 0.02) *
                            5,
                    ]}
                    rotation={[
                ...
                >
                    ...
                    <DynamicMaterial
                        materialConfig={{
                            ...
                            opacity:
                                0.12 +
                                Math.sin(timeRef.current * 0.4 + i) * 0.03, // Very subtle presence
                    ...
                    >
                        ...
                        <DynamicMaterial
                            materialConfig={{
                                ...
                                opacity:
                                    0.2 +
                                    Math.sin(timeRef.current * 0.5 + i) * 0.05,
                ...
                return (
                    <mesh
                        ...
                        position={[
                            ...
                            fragmentHeight +
                                Math.sin(timeRef.current * 0.3 + i) * 0.6,
                            Math.sin(
                                i * ((Math.PI * 2) / 12) +
                                    timeRef.current * 0.04
                            ) * fragmentRadius,
                    ...
                    >
                        ...
                        <DynamicMaterial
                            materialConfig={{
                                ...
                                opacity:
                                    0.15 +
                                    Math.sin(timeRef.current * 0.7 + i) * 0.05,
