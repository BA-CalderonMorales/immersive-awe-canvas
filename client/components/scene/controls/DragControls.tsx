...
const DragControls = ({
    ...
    useEffect(() => {
        ...
        if (
            mainObject &&
            !draggableObjects.some(o => o.uuid === mainObject.uuid)
        ) {
        ...
        const initializeControls = () => {
            const controls = new ThreeDragControls(
                draggableObjects,
                camera,
                gl.domElement
            );
            ...
            const handleDragStart = (event: DragEvent) => {
                ...
                const positionInCameraSpace =
                    camera.worldToLocal(initialPosition);
            ...
            const handleDrag = (event: DragEvent) => {
                ...
                if (object.userData?.objectId && object.position) {
                    ...
                    actions.updateObject(object.userData.objectId, {
                        position,
                    });
                }
            };
