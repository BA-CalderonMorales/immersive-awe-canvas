    ...
    useFrame(state => {
        ...
        switch (animationType) {
            ...
            case "slowPulse":
                ...
                lightRef.current.intensity =
                    baseIntensity *
                    (0.4 + Math.sin(timeRef.current * 0.8) * 0.6);
                break;
            default:
