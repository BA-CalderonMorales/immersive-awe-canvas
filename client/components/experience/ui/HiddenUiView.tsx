...
const HiddenUiView = ({
    ...
    const shouldShowTooltip =
        showUiHint && !showOnboardingHints && !isFirstVisit;
                ...
                {!isMobile && (
                    <div className="absolute bottom-4 left-4 pointer-events-auto z-[60]">
                        <Tooltip open={!showOnboardingHints && !isFirstVisit}>
                            ...
                            <TooltipContent>
                                <p>
                                    Click to show keyboard shortcuts or press M
                                </p>
                            </TooltipContent>
                        </Tooltip>
                    </div>
                ...
                {!isMobile && isVisible && (
                    <div
                        className={`absolute bottom-4 left-4 pointer-events-auto text-xs font-mono rounded-md shadow-lg backdrop-blur-sm min-w-[280px] z-[60] ${
                            theme === "day"
                                ? "bg-white/90 text-black border border-gray-200/50"
                                : "bg-black/90 text-slate-200 border border-gray-700/50"
                        }`}
                    >
                        <Collapsible
                            open={isExpanded}
                        ...
                        >
                            <CollapsibleTrigger asChild>
                                <div className="flex items-center justify-between p-3 pb-2 cursor-pointer hover:bg-black/5 dark:hover:bg-white/5 transition-colors">
                                    <span className="font-semibold">
                                        Shortcuts (use the letter "M" to hide
                                        this menu)
                                    </span>
                                    <Button
                                        variant="ghost"
                            ...
                            <CollapsibleContent className="px-3 pb-3">
                                <div className="space-y-1.5">
                                    <p>
                                        Press{" "}
                                        <span className="font-bold">N</span> to
                                        go to the next world
                                    </p>
                                    <p>
                                        Press{" "}
                                        <span className="font-bold">P</span> to
                                    ...
                                    <p>
                                        Press{" "}
                                        <span className="font-bold">.</span> to
                                        freeze or unfreeze objects
                                    </p>
                                    <p>
                                        Press{" "}
                                        <span className="font-bold">V</span> to
                                        show or hide the interface
                                    </p>
                                    <p>
                                        Press{" "}
                                        <span className="font-bold">Esc</span>{" "}
                                        to open scene settings
                                    </p>
                                    <p>
                                        Press{" "}
                                        <span className="font-bold">S</span> to
                                        search for worlds
                                    </p>
                                    <p>
                                        Press{" "}
                                        <span className="font-bold">H</span> to
                                        open the help guide
                                    </p>
                                    <p>
                                        Press{" "}
                                        <span className="font-bold">G</span> to
                                        return to the home page
                                    </p>
                                    <p>
                                        Press{" "}
                                        <span className="font-bold">C</span> to
