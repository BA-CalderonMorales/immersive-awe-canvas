    ...
    <AlertDialog>
      ...
      <AlertDialogContent className="max-w-md mx-auto p-0 overflow-hidden">
        <AlertDialogHeader className="p-6 pb-4 text-center">
          ...
          <AlertDialogTitle className="text-xl font-semibold">Like this project?</AlertDialogTitle>
          <AlertDialogDescription className="text-sm text-muted-foreground leading-relaxed">
            This is a passion project by one developer. Your support helps bring new features like saving and sharing worlds to life!
          </AlertDialogDescription>
        </AlertDialogHeader>
