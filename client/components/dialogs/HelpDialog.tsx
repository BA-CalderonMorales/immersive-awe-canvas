                ...
                {showIssueForm ? (
                    ...
                    <>
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                Here's how to interact with the experience and
                                get help.
                            </DialogDescription>
                        </DialogHeader>
                                ...
                                <AccordionItem value="controls">
                                    ...
                                    <AccordionContent className="border-t-0 pt-4">
                                        <ul className="list-disc list-inside space-y-2 pl-4 text-sm">
                                            <li>
                                                <b>Look around:</b> Click and
                                                drag with your mouse to rotate
                                                camera.
                                            </li>
                                            <li>
                                                <b>Zoom:</b> Scroll with mouse
                                                wheel or pinch on touchpads.
                                            </li>
                                            <li>
                                                <b>Select Objects:</b> Click on
                                                any geometry to select and show
                                                gizmo controls.
                                            </li>
                                            <li>
                                                <b>Move Objects:</b> Press 'Z'
                                                to toggle drag mode, then drag
                                                gizmo handles for precise
                                                movement.
                                            </li>
                                            <li>
                                                <b>Freeze Scene:</b>{" "}
                                                Double-click the scene or press
                                                '.' (period).
                                            </li>
                                            <li>
                                                <b>Toggle Day/Night:</b> Press
                                                SPACE key.
                                            </li>
                                            <li>
                                                <b>Navigate Worlds:</b> Use
                                                arrow buttons or press 'N' for
                                                next and 'P' for previous.
                                            </li>
                                            <li>
                                                <b>Search Worlds:</b> Press 'S'
                                                or Ctrl+K (Cmd+K on Mac).
                                            </li>
                                            <li>
                                                <b>Show/Hide UI:</b> Press 'V'.
                                            </li>
                                            <li>
                                                <b>Toggle Settings Panel:</b>{" "}
                                                Press 'E' to open scene editor.
                                            </li>
                                            <li>
                                                <b>Copy Scene Config:</b> Press
                                                'C' to copy current scene
                                                configuration.
                                            </li>
                                            <li>
                                                <b>Go Home:</b> Press 'G'.
                                        ...
                                        <div className="text-sm text-muted-foreground space-y-4">
                                            <div>
                                                ...
                                                <ul className="list-disc list-inside space-y-1 pl-4">
                                                    <li>
                                                        Multiple 3D scene types
                                                        with optimized
                                                        animations
                                                    </li>
                                                    <li>
                                                        Blender-style gizmo
                                                        controls for precise
                                                        object manipulation
                                                    </li>
                                                    <li>
                                                        Professional scene
                                                        editor with real-time
                                                        property adjustment
                                                    </li>
                                                    <li>
                                                        Dynamic object
                                                    ...
                                                    <li>
                                                        ...
                                                        with world-specific UI
                                                        colors
                                                    </li>
                                                    <li>
                                                        Comprehensive keyboard
                                                        shortcuts for efficient
                                                        navigation
                                                    </li>
                                                    <li>
                                                        Responsive design
                                            ...
                                            <p>
                                                This project follows semantic
                                                versioning and conventional
                                                commits. Report issues or
                        ...
                        <DialogFooter className="pt-4 flex-col sm:flex-row sm:justify-between items-center border-t mt-4">
                            ...
                            <div className="flex gap-2">
                                ...
                                >
                                    <Github className="mr-2 h-4 w-4" /> Report
                                    Issue
                                </Button>
                            </div>
                        </DialogFooter>
