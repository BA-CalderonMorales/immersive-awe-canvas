...
const OnboardingHints = ({ isVisible, theme }: OnboardingHintsProps) => {
    ...
    return (
        <div className="pointer-events-none fixed inset-0 z-30">
            {/* Show UI button hint */}
            <div
                className={`absolute ${isMobile ? "top-6 right-20" : "top-2 right-20 sm:top-6 sm:right-24"}`}
            >
          ...
          `}
            ...
            <div
                className={`absolute ${isMobile ? "top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 px-6" : "top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"}`}
            >
          ...
          `}
            ...
            <div
                className={`absolute ${isMobile ? "bottom-20 left-1/2 -translate-x-1/2 px-6" : "bottom-16 left-1/2 -translate-x-1/2"}`}
            >
          ...
          `}
                    >
                        <div
                            className={`${isMobile ? "text-xs" : "text-sm"} font-medium space-y-0.5`}
                        >
                            <div
                                className={`
