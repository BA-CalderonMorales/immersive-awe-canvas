...
-- Create sequence for backgrounds table
CREATE SEQUENCE public.backgrounds_id_seq OWNED BY public.backgrounds.id;
...
-- Create sequence for default_geometries table  
CREATE SEQUENCE public.default_geometries_id_seq OWNED BY public.default_geometries.id;
