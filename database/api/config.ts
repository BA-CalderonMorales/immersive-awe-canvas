...
const SUPABASE_URL =
    process.env.SUPABASE_URL || "https://vpqadqhqphmtdkepvnet.supabase.co";
const SUPABASE_ANON_KEY =
    process.env.SUPABASE_ANON_KEY ||
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZwcWFkcWhxcGhtdGRrZXB2bmV0Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDk5NDg0OTMsImV4cCI6MjA2NTUyNDQ5M30.cxyPs3buUZsOMyhMiNr25RexN8MZL9QWBbUGX4--084";
const GITHUB_REPO =
    process.env.GITHUB_REPO || "BA-CalderonMorales/immersive-awe-canvas";
